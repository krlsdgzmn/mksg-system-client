...
export default function KPICard({
  ...
  return (
    <div className="col-span-3 grid grid-cols-7 rounded-md border border-border bg-card p-4 pr-0 shadow dark:bg-muted-foreground/10 md:col-span-1">
      <div className="col-span-5 border-r border-border pr-1.5">
