...
export default function OrderStatusTable({
  ...
  return (
    <div className="remove-scrollbar hidden h-[548px] w-full overflow-auto rounded-md border border-border bg-card px-4 py-4 dark:bg-muted-foreground/10 md:block">
